<script lang="ts">
  ...
  function updateNotifications(): void {
    ...
    // ลบการแจ้งเตือนหลังจาก 1 นาที (60 วินาที) ผ่านไปนับจากเวลาเป้าหมาย
    notifications = notifications.filter((n) => {
      ...
      // 2. น้อยกว่า 1 นาทีที่ผ่านมาตั้งแต่เหตุการณ์ (timeLeft อยู่ระหว่าง 86340 และ 86400)
      // 3. หรือเพิ่งผ่านเหตุการณ์ (ภายใน 60 วินาที)
      return (
        timeLeft > 0 ||
        (timeLeft >= 86340 && timeLeft < 86400) ||
        Math.abs(timeLeft) < 60
      );
    });
  }
